...
/**
 * @defgroup net_gnrc_gomach_conf GNRC GoMacH compile configurations
...
#else
#if ((CONFIG_GNRC_GOMACH_SUPERFRAME_DURATION_US < \
...
#if (((1000LU *US_PER_MS) / RTT_FREQUENCY) > \
     (10 * CONFIG_GNRC_GOMACH_CP_DURATION_US))
...
#define GNRC_GOMACH_CP_DURATION_MAX_US \
     (5LU * CONFIG_GNRC_GOMACH_CP_DURATION_US)
#endif
