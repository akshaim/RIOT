...
#define GNRC_LWMAC_PREAMBLE_DURATION_US \
    ((13LU * CONFIG_GNRC_LWMAC_WAKEUP_INTERVAL_US) / 10)
#endif
...
#define GNRC_LWMAC_BROADCAST_DURATION_US \
    ((CONFIG_GNRC_LWMAC_WAKEUP_INTERVAL_US * 11) / 10)
#endif
...
#define GNRC_LWMAC_TIME_BETWEEN_BROADCAST_US \
